...
registerForEvent('onUpdate', function(dt)
    ...
    -- WHEEL GRAB owns the grip while a hand is at the steering wheel: shared[159] bit0 = the
    -- right hand is there. The grip that grabs the wheel must not also equip a weapon, and the
    -- flag is raised on PROXIMITY -- before the press -- so there is no edge to race.
    local wheelArmed = GetVRSharedSlot(159)
