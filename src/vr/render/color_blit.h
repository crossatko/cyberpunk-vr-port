...
public:
    ...
    struct HudParams {
        ...
        // Horizontal shift of the HUD SAMPLE, in UV. Filled by the caller for the second eye:
        // zero means the HUD sits at the same pixel in both eyes, i.e. at optical infinity, and
        // an icon at infinity has no chance of fusing while the world is an arm's length away.
